...
- [Server VirtualMachine Setup](#server-virtualmachine-setup)
    ...
    - [__2. Install sudo and add user to sudoers__](#1-install-sudo-and-add-user-to-sudoers)
    - [__3. Setting up the firewall__](#2-setting-up-the-firewall)
    - [__4. Setting server's Static IP__](#3-setting-servers-static-ip)
    - [__5. Installing GLPI__](#4-installing-glpi)
    - [__6. Setting up a DNS server__](#5-setting-up-a-dns-server)
    - [__7. Setting up a DHCP server__](#6-setting-up-a-dhcp-server)
    - [__8. Weekly Backup of Configurations__](#7-weekly-backup-of-configurations)
